...
<nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb">
        ...
        <?php endif; ?>
        <li class="breadcrumb-item active"><?= e($image['name']) ?></li>
    </ol>
</nav>
...
<div class="row">
    ...
    <div class="col-lg-8">
        ...
        <div class="text-center bg-dark rounded-3 p-2 mb-3">
            <img id="primary-detail-img" src="<?= e($primaryUrl) ?>" alt="<?= e($image['name']) ?>" class="detail-primary-img img-fluid">
        </div>
        ...
        <div class="d-flex gap-2 mb-3">
            <img src="<?= e($image['primary_image']) ?>" class="detail-gallery-thumb active" alt="Primary">
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm rounded-3 p-4">
            ...
            <h3 class="fw-bold"><?= e($image['name']) ?></h3>
...
<div class="mt-5">
    <h4 class="fw-bold mb-3"><i class="fas fa-th me-2"></i>Related Images</h4>
    <div class="row g-3">
            ...
            <a href="<?= SITE_URL ?>/image-detail.php?id=<?= $rel['id'] ?>" class="text-decoration-none">
                <div class="image-card card h-100">
                    <div class="card-img-wrapper">
                        ...
                        <img class="lazy" data-src="<?= e($relThumb) ?>" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1 1'%3E%3C/svg%3E" alt="<?= e($rel['name']) ?>">
                    </div>
                    <div class="card-body">
